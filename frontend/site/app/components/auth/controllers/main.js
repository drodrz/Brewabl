...
angular.module('brewablApp')
  .controller('MainCtrl', function ($scope, $cookies, $location, djangoAuth) {
    ...
    $scope.login = function(){
      djangoAuth.login(prompt('Email'),prompt('Password'))
      .then(function(data){
        handleSuccess(data);
      },handleError);
    }
    ...
    $scope.register = function(){
      djangoAuth.register(prompt('Name'),prompt('Email'),prompt('Password'))
      .then(handleSuccess,handleError);
    }
    ...
    $scope.updateProfile = function(){
      djangoAuth.updateProfile({'name': prompt("Name"), 'email': prompt("Email")})
      .then(handleSuccess,handleError);
    }
